...
void ReceivedBytes(Ptr<OutputStreamWrapper> stream)
{
  ...
  *stream->GetStream() << now.GetSeconds() << "\t"
                       ...
                       << sink3->GetTotalRx() << "\t" << std::endl;                     // received bytes in sink3
...
int main(int argc, char *argv[])
{
  ...
  Simulator::Schedule(Seconds(1.1),
                      &ReceivedBytes,
                      asciiTraceHelper.CreateFileStream("prac3_1-4.rx"));
  ...
  ns3TcpSocket1->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_1-4_app1.cwnd")));
  ...
  ns3TcpSocket2->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_1-4_app2.cwnd")));
  ...
  ns3TcpSocket3->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_1-4_app3.cwnd")));
  ...
  ns3TcpSocket1->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_1-4_app1.ssthresh")));
  ...
  ns3TcpSocket2->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_1-4_app2.ssthresh")));
  ...
  ns3TcpSocket3->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_1-4_app3.ssthresh")));
