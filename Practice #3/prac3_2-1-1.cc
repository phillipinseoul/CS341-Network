...
int main(int argc, char *argv[])
{
  ...
  Simulator::Schedule(Seconds(1.1),
                      &ReceivedBytes,
                      asciiTraceHelper.CreateFileStream("prac3_2-1-1_throughput.rx"));
  ...
  ns3TcpSocket1->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_2-1-1_app1.cwnd")));
  ...
  ns3TcpSocket2->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_2-1-1_app2.cwnd")));
  ...
  ns3TcpSocket3->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_2-1-1_app3.cwnd")));
  ...
  ns3TcpSocket1->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_2-1-1_app1.ssthresh")));
  ...
  ns3TcpSocket2->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_2-1-1_app2.ssthresh")));
  ...
  ns3TcpSocket3->TraceConnectWithoutContext(
      ...
      MakeBoundCallback(
          &NotifyChange,
          asciiTraceHelper.CreateFileStream("prac3_2-1-1_app3.ssthresh")));
